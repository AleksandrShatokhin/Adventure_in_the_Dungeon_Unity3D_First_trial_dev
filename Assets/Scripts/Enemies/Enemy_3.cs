...
public class Enemy_3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        spawnBall = GameObject.Find("EnemySpawnBall_3").GetComponent<Transform>();

        startEnemyPos = transform.position;
        endEnemyPos = new Vector3(transform.position.x + 22, transform.position.y, transform.position.z);
